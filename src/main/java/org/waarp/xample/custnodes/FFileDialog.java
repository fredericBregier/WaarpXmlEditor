...
/**
 * FFileDialog is a file dialog, which can be used as a custom field editor for the {@link com.fg.xmleditor.FXBasicView}. Since
 * FFileDialog is a JDialog, it can be used as both
